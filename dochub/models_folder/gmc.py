...
INDICATOR_CHOICES = (
    ...
    (7, 'Adequate Experience'),
    (8, 'Reporting Systems'),
    (9, 'Clinical Supervision'),
    (10, 'Induction'),
    (11, 'Study Leave'),
    (12, 'Work Load'),
    (13, 'Clinical Supervision out of hours'),
    (14, 'Local Teaching'),
...
BENCHMARK_CHOICES = (
    ...
    (13,'Community Sexual and Reproductive Health'), 
    (14,'Dermatology'),
    (15,'Emergency Medicine'), 
    (16,'Endocrinology and diabetes mellitus'),
    (17, 'Forensic psychiatry'), 
    (18, 'Gastroenterology'),
    (19,'General (internal) medicine'), 
    (20, 'General surgery'),
    (21, 'Genito-urinary medicine'), 
    ...
    (84, 'Metabolic Medicine'),
    (85, 'Pre-hospital Emergency Medicine'),
    (86, 'Sexual and Reproductive Health'), 
    (87, 'Urogynaecology'),
    (88, 'Neuropathology'), 
    (89, 'Medical microbiology and virology'),
    (90, 'Aviation and space medicine'), 
    (91, 'Pharmaceutical medicine'),
    (92, 'All General Practice Posts'),
    (93, 'All Psychiatry Posts'),
    (94, 'All Medicine Posts'),
    (95, 'All Anaesthetists Posts'),
    (96, 'All Surgery Posts'),
    (97, 'All Pathology Posts'),
    (98, 'All Radiology Posts'),
